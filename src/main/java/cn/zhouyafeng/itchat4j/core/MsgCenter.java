...
//								MessageTools.sendMsgById(result, core.getMsgList().get(0).getFromUserName());
								MessageTools.sendPicMsgByUserId(core.getMsgList().get(0).getFromUserName(), result);
...
//								MessageTools.sendMsgById(result, core.getMsgList().get(0).getFromUserName());
								MessageTools.sendFileMsgByUserId(core.getMsgList().get(0).getFromUserName(), result);
								...
								MessageTools.sendMsgById("系统消息", core.getMsgList().get(0).getFromUserName());
